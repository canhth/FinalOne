...
public extension UIView {
    ...
    public func animate(animations: [Animation],
        ...
        alpha = initialAlpha
        UIView.animate(withDuration: duration, delay: delay, usingSpringWithDamping: springWithDamping, initialSpringVelocity: velocity, options: options, animations: { [weak self] in
